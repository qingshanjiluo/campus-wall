...
(function () {
  const NAV_HTML = `
    ...
    <nav class="navbar" id="navbar" role="navigation" aria-label="主导航">
        ...
        <ul class="nav-links" id="navLinks">
            ...
            <li><a href="/qna" id="navQna"><i data-lucide="circle-help" class="icon nav-icon"></i> 问答</a></li>
  ...
  function initCommon() {
    ...
    const navMap = {
      ...
      '/world': 'navWorld', '/forum': 'navForum', '/expose': 'navExpose', '/tasks': 'navTasks', '/chat': 'navChat', '/events': 'navEvents', '/qna': 'navQna'
    };
